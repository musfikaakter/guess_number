...
const preGuessLink = document.querySelector("#previous_guess");
const showPreviousGuess = document.querySelector(".show_guesses");

preGuessLink.addEventListener("click", () => {
  showPreviousGuess.textContent = userInputs.join(", ");
});
...
rangeBtn.forEach(btn => {
    ...
    showRange.classList.remove("show");
        range = parseInt(btn.textContent);
